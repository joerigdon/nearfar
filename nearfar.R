...
summary.nf = function(x) {
    stopifnot(inherits(x, "nf"))
    cat("\t\n",
...
angrist = read.csv("/Users/jrigdon/Box Sync/Rigdon/Sanjay/Paper1/angrist.csv", header=TRUE)
